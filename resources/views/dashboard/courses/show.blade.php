    ...
    <div class="row my-3">
        <div class="col-lg-8">
            <article>
                ...
                <a href="/dashboard/courses" class="btn btn-success"><span data-feather="arrow-left"></span> Back</a>
                <a href="/dashboard/courses/{{ $course->id }}/edit" class="btn btn-warning"><span data-feather="edit"></span> Edit</a>
